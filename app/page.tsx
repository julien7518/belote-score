...
export default function App() {
	...
	function calculateScore(): void {
		...
		if (score && !onlyCountered) {
			...
			const roundedScore = (numericScore % 10 >= 5) ? numericScore + (10 - numericScore % 10) : numericScore - (numericScore % 10);
			if (inputUs && inputThey && roundedScore < totalPoints) {
				inputUs.value = String(roundedScore * multiplier * counter * overCounter);
				inputThey.value = String((totalPoints - roundedScore) * multiplier * counter * overCounter);
				addBelote();
			}
		}
	}
